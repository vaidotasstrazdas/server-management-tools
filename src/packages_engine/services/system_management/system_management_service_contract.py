"""System Management Service Contract - defines interface for low-level system operations."""
...
class SystemManagementServiceContract(ABC):
    """
    Abstract base class defining the contract for system management services.

    Provides low-level system operations including package management, service control,
    and command execution. This is typically implemented by platform-specific engine services.
    """
