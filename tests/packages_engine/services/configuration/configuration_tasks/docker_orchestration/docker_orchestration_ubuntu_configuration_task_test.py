...
class TestDockerOrchestrationUbuntuConfigurationTask(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reader.read_result = OperationResult[str].succeed("docker-compose-config-result")
    ...
    def test_docker_configuration_is_saved_correctly(self):
        ...
        self.assertEqual(
            ...
            [WriteTextParams("/srv/stack/docker-compose.yml", "docker-compose-config-result")],
        )
    ...
    def test_notifications_happy_flow_is_correct(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                {"text": '\tCreating directory "/srv/gitea/data" if needed.', "type": "info"},
                {
                ...
                {"text": '\tCreating directory "/srv/gitea/config" if needed.', "type": "info"},
                {
                ...
                {"text": '\tCreating directory "/srv/postgres/data" if needed.', "type": "info"},
                {
                ...
                {"text": '\tCreating directory "/srv/pgadmin/data" if needed.', "type": "info"},
                {
    ...
    def test_task_results_in_failure_when_failing_to_create_gitea_data_folder(self):
        self._command_failure_results_in_failure("sudo mkdir -p /srv/gitea/data")

    def test_task_results_in_failure_when_failing_to_create_gitea_config_folder(self):
        self._command_failure_results_in_failure("sudo mkdir -p /srv/gitea/config")

    def test_task_results_in_failure_when_failing_to_create_postgres_data_folder(self):
        self._command_failure_results_in_failure("sudo mkdir -p /srv/postgres/data")

    def test_task_results_in_failure_when_failing_to_create_pgadmin_data_folder(self):
        self._command_failure_results_in_failure("sudo mkdir -p /srv/pgadmin/data")
    ...
    def test_task_results_in_failure_when_failing_to_chown_postgres_data_folder(self):
        self._command_failure_results_in_failure("sudo chown -R 999:999 /srv/postgres/data")

    def test_task_results_in_failure_when_failing_to_chown_pgadmin_data_folder(self):
        self._command_failure_results_in_failure("sudo chown -R 5050:5050 /srv/pgadmin/data")

    def test_task_results_in_failure_when_failing_to_start_docker_containers(self):
        self._command_failure_results_in_failure("cd /srv/stack && sudo docker compose up -d")
    ...
    def test_task_results_in_correct_notifications_when_failing_to_create_gitea_folder(self):
        self._command_failure_results_in_notifications(
            ...
            [
                ...
                {"text": '\t\tCreation of the directory "/srv/gitea" failed.', "type": "error"},
    ...
    def test_task_results_in_correct_notifications_when_failing_to_create_postgres_folder(self):
        self._command_failure_results_in_notifications(
            ...
            [
                ...
                {"text": '\t\tCreation of the directory "/srv/postgres" failed.', "type": "error"},
                {"text": "\tCreating directories operation failed.", "type": "error"},
            ],
        )
    ...
    def test_task_results_in_correct_notifications_when_failing_to_create_pgadmin_folder(self):
        self._command_failure_results_in_notifications(
            ...
            [
                ...
                {"text": '\t\tCreation of the directory "/srv/pgadmin" failed.', "type": "error"},
                {"text": "\tCreating directories operation failed.", "type": "error"},
            ],
        )
    ...
    def test_task_results_in_correct_notifications_when_failing_to_create_postgres_data_folder(
        self,
    ):
        self._command_failure_results_in_notifications(
            "sudo mkdir -p /srv/postgres/data",
    ...
    def test_task_results_in_correct_notifications_when_failing_to_create_srv_stack_folder(self):
        self._command_failure_results_in_notifications(
            ...
            [
                ...
                {"text": '\t\tCreation of the directory "/srv/stack" failed.', "type": "error"},
                {"text": "\tCreating directories operation failed.", "type": "error"},
            ],
        )
    ...
    def _command_failure_results_in_notifications(
        self, command: str, expected_notifications: list[object]
    ):
        # Arrange
        self.controller.run_raw_commands_result_regex_map.pop(
            "sudo chown -R 999:999 /srv/postgres/data"
