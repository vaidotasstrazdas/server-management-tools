...
class TestDnsmasqUbuntuConfigurationTask(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.task = DnsmasqUbuntuConfigurationTask(self.reader, self.file_system, self.notifications, self.controller)
    ...
    def test_happy_path_results_in_correct_notifications_flow(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                { 'type':'success', 'text': '\tReading Dnsmasq Config template data successful.' },
                { 'type':'info', 'text': 'Writing Dnsmasq Config data.' },
                { 'type':'success', 'text': '\tWriting Dnsmasq Config data successful.' },
                { 'type':'info', 'text': 'Restarting Dnsmasq' },
                { 'type':'success', 'text': '\tRestarting Dnsmasq successful' },
            ]
        )
    ...
    def test_reads_config_using_correct_parameters(self):
        ...
        self.assertEqual(
            ...
            [ReadParams(ConfigurationContent.RAW_STRING, self.data, '/usr/local/share/srv/data/dnsmasq.conf')]
        )
    ...
    def test_write_failure_result_in_correct_notifications_flow(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                { 'type':'success', 'text': '\tReading Dnsmasq Config template data successful.' },
                { 'type':'info', 'text': 'Writing Dnsmasq Config data.' },
                { 'type':'error', 'text': '\tWriting Dnsmasq Config data failed.' },
            ]
        )
    ...
    def test_running_commands_failure_results_in_correct_notifications_flow(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                { 'type':'success', 'text': '\tWriting Dnsmasq Config data successful.' },
                { 'type':'info', 'text': 'Restarting Dnsmasq' },
                { 'type':'error', 'text': '\tRestarting Dnsmasq failed' },
            ]
        )