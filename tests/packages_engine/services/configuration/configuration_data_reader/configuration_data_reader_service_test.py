...
class TestConfigurationDataReaderService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.option_data = ConfigurationData(
            ...
            gitea_admin_login="admin",
            gitea_admin_email="admin@example.com",
            gitea_admin_password="gitea-admin-pwd",
            gitea_secret_key="gitea-secret",
    ...
    def test_correct_parameters_are_read(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                ReadParams[str]("Gitea Admin User Name", "admin", 7),
                ReadParams[str]("Gitea Admin User Email", "admin@example.com", 8),
                ReadParams[str]("Gitea Admin Password", "123456", 9),
                ReadParams[str]("Gitea Secret Key", "secret-key", 10),
                ReadParams[str]("PostgreSQL Admin Email", "user@example.com", 11),
                ReadParams[str]("PostgreSQL Admin Password", "123456", 12),
                ReadParams[str]("Name of the Server Client #1", None, 14),
                ReadParams[str]("Name of the Server Client #2", None, 15),
                ReadParams[str]("Mounted directory for the Clients Configuration", None, 16),
            ],
        )
        self.assertEqual(
            int_params,
            [
                ReadParams[int]("Number of Server Clients", 2, 13),
            ],
        )
    ...
    def test_correct_parameters_are_read_with_option_when_selection_to_use_options_not_made(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                ReadParams[str]("Gitea Admin User Name", "admin", 8),
                ReadParams[str]("Gitea Admin User Email", "admin@example.com", 9),
                ReadParams[str]("Gitea Admin Password", "123456", 10),
                ReadParams[str]("Gitea Secret Key", "secret-key", 11),
                ReadParams[str]("PostgreSQL Admin Email", "user@example.com", 12),
                ReadParams[str]("PostgreSQL Admin Password", "123456", 13),
                ReadParams[str]("Name of the Server Client #1", None, 15),
                ReadParams[str]("Name of the Server Client #2", None, 16),
                ReadParams[str]("Mounted directory for the Clients Configuration", None, 17),
            ],
        )
        self.assertEqual(
            int_params,
            [
                ReadParams[int]("Number of Server Clients", 2, 14),
            ],
        )
