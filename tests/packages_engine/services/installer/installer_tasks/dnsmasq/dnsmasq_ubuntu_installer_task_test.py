...
class TestDnsmasqUbuntuInstallerTask(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.task = DnsmasqUbuntuInstallerTask(self.notifications, self.engine, self.controller)
    ...
    def test_notification_flow_when_dnsmasq_installed_already(self):
        # Arrange
        ...
        self.assertEqual(
            ...
            [
                ...
                {'type':'success','text':'\tDnsmasq is installed already. Nothing needs to be done.'},
            ]
        )

    def test_notification_flow_when_dnsmasq_not_installed(self):
        # Arrange
    ...
    def test_returns_result_from_packages_controller_when_dnsmasq_not_installed(self):
        # Arrange
        self.engine.is_installed_result = False
